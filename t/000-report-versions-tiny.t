...
eval { $v .= pmver('Digest::xxHash','any version') };
eval { $v .= pmver('ExtUtils::MakeMaker','6.30') };
eval { $v .= pmver('File::Spec','any version') };
eval { $v .= pmver('File::Temp','any version') };
eval { $v .= pmver('File::Util','any version') };
...
eval { $v .= pmver('Term::ProgressBar','any version') };
eval { $v .= pmver('Term::Prompt','any version') };
eval { $v .= pmver('Test','any version') };
eval { $v .= pmver('Test::More','0.88') };
eval { $v .= pmver('Test::NoWarnings','any version') };
eval { $v .= pmver('Thread::Queue','any version') };
eval { $v .= pmver('Time::HiRes','any version') };
eval { $v .= pmver('Try::Tiny','any version') };
eval { $v .= pmver('lib','any version') };
eval { $v .= pmver('strict','any version') };
eval { $v .= pmver('threads','any version') };
eval { $v .= pmver('threads::shared','any version') };
